...
export const ROUTE_NAMES = {
  ...
  S3_SIGNED_URLS: 'api/s3/generate-signed-url',
  LISTINGS: 'api/listings',
  LOCATION_SEARCH: 'api/search/location',
  LISTING_SEARCH: 'api/search/listing',
  LOGIN: 'api/login'
...
//
//   GET_LOCATION_SEARCH: `GET /${ROUTE_NAMES.LOCATION_SEARCH}`,
//   GET_LISTING_SEARCH: `GET /${ROUTE_NAMES.LISTING_SEARCH}`
//
// } as const
