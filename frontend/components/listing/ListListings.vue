...
import { newListing } from '@backend/listing/listing'
...
import { ListingDTO } from '~/store/generated'
...
export default class ListListings extends Vue {
  ...
  selectedListing?: ListingDTO = newListing()
  ...
  loadListing (listing: ListingDTO) {
