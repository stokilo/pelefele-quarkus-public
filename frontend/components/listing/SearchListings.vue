                  ...
                  <form>
                    <div class="field has-addons has-shadow-field">
                      <div class="control has-icons-left is-expanded">
                        <SearchAutocomplete
                          v-model="listingSearchStore.selectedLocation.location"
                    ...
                    <SearchFilters
                      ...
                      :listing-search-params-v-m="listingSearchStore.listingSearchParamsVM"
                      :listing-property-types="listingSearchStore.listingPropertyTypes"
                      :listing-purposes="listingSearchStore.listingPurposes"
                    />
              ...
              <div class="column is-10">
                ...
                >
                  <SearchItem
                    ...
                    :price="listing.price"
                    :area="listing.area"
                    :cover-file-name="listing.assets.filter(e=>e.isCover).length ? listing.assets.filter(e=>e.isCover)[0].fileName : ''"
                  />
                </div>
                ...
                <b-pagination
                  ...
                  :per-page="listingSearchStore.listingSearchParamsVM.pageSize"
                  range-before="3"
                  range-after="1"
                  order="is-centered"
                  size="is-medium"
